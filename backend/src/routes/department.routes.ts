...
router.put('/:id', requirePermission(Permission.UPDATE_DEPARTMENT), async (req: Request, res: Response) => {
  try {
    ...
    if (typeof req.body.descriptionHi === 'string') updateData.descriptionHi = req.body.descriptionHi.trim();
    if (typeof req.body.descriptionOr === 'string') updateData.descriptionOr = req.body.descriptionOr.trim();
    if (typeof req.body.descriptionMr === 'string') updateData.descriptionMr = req.body.descriptionMr.trim();
    if (typeof req.body.contactPerson === 'string') updateData.contactPerson = req.body.contactPerson.trim();
    ...
    if (typeof req.body.parentDepartmentId === 'string' || req.body.parentDepartmentId === null) {
      updateData.parentDepartmentId = req.body.parentDepartmentId;
    }
