        ...
        <div className="relative z-10 flex flex-col h-full p-10 xl:p-14">
          ...
          <div className="mt-auto mb-8">
            <h1 className="text-3xl xl:text-4xl font-black text-white leading-[1.1] tracking-tight mb-5">
              Empowering <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-sky-400 to-emerald-400 italic font-medium">
                Digital Republic
              </span>
            </h1>
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="group p-4 xl:p-5 rounded-2xl xl:rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300 backdrop-blur-md">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-white text-xs xl:text-sm">
                      Military-Grade Security
                    </h4>
                    <p className="text-slate-500 text-[11px] xl:text-xs font-medium">
                      End-to-end encrypted citizen data
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group p-4 xl:p-5 rounded-2xl xl:rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300 backdrop-blur-md">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-[11px] xl:text-xs font-medium">
                      Live monitoring and trend analysis
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-10">
          <div className="w-full max-w-md lg:max-w-lg">
            <div className="mb-3 xl:mb-4 text-center lg:text-left">
              <h2 className="text-2xl xl:text-3xl font-extrabold text-slate-900 tracking-tight leading-none mb-2 uppercase">
                Welcome Back
              </h2>
              <p className="text-slate-500 text-sm xl:text-base font-medium">
                Log in to manage your administrative dashboard
              </p>
            </div>
            ...
            <div className="relative group">
              ...
              <Card className="relative bg-white border border-slate-200 shadow-[0_20px_40px_-12px_rgba(0,0,0,0.06)] rounded-[2rem] overflow-hidden">
                ...
                <CardHeader className="pt-5 px-8 xl:px-10 pb-0">
                  <CardTitle className="text-lg xl:text-xl font-black text-slate-800 tracking-tight">
                    Login Portal
                  </CardTitle>
                  <CardDescription className="text-slate-500 text-xs xl:text-sm font-medium">
                ...
                <CardContent className="px-8 xl:px-10 py-5">
                  ...
                  >
                    <div className="space-y-1.5 xl:space-y-2">
                      <Label
                        htmlFor="phone"
                        className="text-slate-800 font-bold text-xs xl:text-sm uppercase tracking-wider ml-1"
                      >
                        Phone Number
                      </Label>
                      <div className="relative group">
                    ...
                    <div className="space-y-1.5 xl:space-y-2">
                      <div className="flex justify-between items-center ml-1">
                        <Label
                          htmlFor="password"
                          className="text-slate-800 font-bold text-xs xl:text-sm uppercase tracking-wider"
                        >
                          Password
                        </Label>
                        <button
