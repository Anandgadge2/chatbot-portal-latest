  ...
  const fetchUsers = useCallback(
    async (page = userPage, isSilent = false) => {
      ...
      try {
        ...
        const selectedRole = userFilters.role || '';
        const serverRoleFilter = selectedRole.startsWith('CUSTOM:')
          ? undefined
        ...
        if (response.success) {
          ...
          setUserPagination((prev) => ({
            ...prev,
            total: selectedRole.startsWith('CUSTOM:')
              ? filteredUsers.length
              : response.data.pagination.total,
            pages: selectedRole.startsWith('CUSTOM:')
