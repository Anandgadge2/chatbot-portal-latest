                        ...
                        <tr className={`group transition-all ${isExpanded ? "bg-indigo-50/30" : "hover:bg-slate-50/50"}`}>
                          <td className="px-4 lg:px-8 py-4 lg:py-6">
                            <div className="flex items-center gap-3 lg:gap-4">
                              <div className={`w-10 h-10 lg:w-12 lg:h-12 rounded-xl lg:rounded-2xl flex items-center justify-center border shadow-sm ${role.isSystem ? "bg-indigo-50 border-indigo-100" : "bg-slate-50 border-slate-200"}`}>
                                <Shield className={`w-5 h-5 lg:w-6 lg:h-6 ${role.isSystem ? "text-indigo-500" : "text-slate-400"}`} />
                              </div>
                          ...
                          <td className="px-4 lg:px-8 py-4 lg:py-6 text-right">
                             ...
                             >
                               ...
                               <Bell className={`w-3.5 h-3.5 ml-1 lg:ml-2 ${isExpanded ? "animate-bounce" : ""}`} />
                             </Button>
                          </td>
                        </tr>
                        {isExpanded && (
                            ...
                            <div className="flex items-center gap-3 lg:gap-4">
                              <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-xl lg:rounded-2xl flex items-center justify-center border bg-white border-slate-200 shadow-sm relative shrink-0 overflow-hidden group-hover:border-indigo-200 transition-colors">
                                {u.firstName ? (
                                  ...
                                  <UserIcon className="w-5 h-5 lg:w-6 lg:h-6 text-slate-300" />
                                )}
                                {isModified && (
                                  <div className="absolute top-1 right-1 w-2 h-2 bg-indigo-500 rounded-full border-2 border-white" />
                                )}
                              </div>
                              <div className="min-w-0">
