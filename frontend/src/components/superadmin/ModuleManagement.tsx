      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* <button
            ...
            disabled={syncing}
            className="flex items-center gap-2 h-10 px-4 bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-emerald-100 transition-all disabled:opacity-50"
          >
            <RefreshCw
          ...
          <Button
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl h-10 px-6 font-black text-[11px] uppercase tracking-widest transition-all shadow-lg shadow-indigo-600/10"
          >
        ...
        {modules.length === 0 && !loading ? (
          <div className="border-2 border-dashed border-slate-200 rounded-3xl p-12 flex flex-col items-center justify-center text-center space-y-4">
            ...
            <Button
              ...
              variant="outline"
              className="mt-4 border-indigo-200 text-indigo-600 hover:bg-indigo-50 font-black text-[10px] uppercase tracking-widest px-8 rounded-xl h-10 transition-all active:scale-95"
            >
            ...
            {modules.map((mod) => (
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {mod.permissions.map((p, i) => (
                        <span
                          key={i}
                          className="px-2 py-0.5 bg-slate-50 text-[9px] font-black text-slate-600 rounded-md border border-slate-100 uppercase tracking-wider"
                        >
                          {p.label}
                        </span>
                      ))}
                  ...
                  {mod.isSystem && (
                    <div className="pt-2">
                      <span className="inline-flex items-center px-2 py-0.5 rounded text-[8px] font-black bg-indigo-50 text-indigo-600 border border-indigo-100 uppercase tracking-widest">
                ...
                {modules.map((mod) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <code className="text-[10px] font-mono bg-slate-100 px-1.5 py-0.5 rounded text-indigo-600 font-bold uppercase tracking-tight">
                        {mod.key}
                      </code>
                    </td>
                    <td className="px-6 py-4">
                      <span className="px-2 py-0.5 bg-slate-50 text-[9px] font-black text-slate-500 rounded border border-slate-100 uppercase tracking-widest">
                        {mod.category}
                      </span>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        {mod.isSystem && (
                          <span className="mr-2 inline-flex items-center px-2 py-0.5 rounded text-[8px] font-black bg-indigo-50 text-indigo-600 border border-indigo-100 uppercase tracking-widest">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                  ...
                  <Button
                    ...
                    className="h-7 text-[9px] font-black uppercase tracking-widest bg-slate-100 hover:bg-slate-200 rounded-lg"
                  >
              ...
              <div className="flex gap-4 pt-4 sticky bottom-0 bg-white">
                <Button
                  ...
                  variant="outline"
                  onClick={() => setShowForm(false)}
                  className="flex-1 h-12 rounded-2xl border-slate-200 font-black text-[11px] uppercase tracking-widest"
                >
                  Cancel
                </Button>
                <Button
                  type="submit"
                  className="flex-2 h-12 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-black text-[11px] uppercase tracking-widest px-12 transition-all shadow-lg shadow-indigo-600/20"
                >
