                    ...
                    >
                      ...
                      <td className="px-5 py-4 whitespace-nowrap">
                        <div className="flex flex-col">
                          <span className="text-xs font-bold text-slate-800">{company.companyHead?.name || "N/A"}</span>
                          <span className="text-[9px] text-slate-400 font-bold uppercase italic">{company.companyHead?.email || "No Head Assigned"}</span>
                        </div>
                      </td>
                      <td className="px-5 py-4 whitespace-nowrap">
